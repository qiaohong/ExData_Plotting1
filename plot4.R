...
par(mfrow=c(2,2))
plot(data$date_time, as.numeric(data$Global_active_power), type = "l", xlab=" ", ylab="Global Active Power (kilowatts)", main=" ")
plot(data$date_time, as.numeric(data$Voltage), type = "l", xlab ="datetime", ylab="Voltage")
...
plot(data$date_time, as.numeric(data$Global_reactive_power), type = "l", xlab="datetime", ylab="Global_reactive_power", main=" ")
dev.off()
